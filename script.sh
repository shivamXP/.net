...
sudo aws cloudformation deploy --template-file ./cloudformation/service.yaml  --stack-name shivamServiceProd --parameter-overrides ImageTag=$dt --capabilities CAPABILITY_IAM --region us-east-1
cd ..
rm -rf .net